...
import puzzle from '../../images/puzzle-piece-solid.svg';
  ...
  return (
    <div className="container">
      ...
      <div className="row mt-3">
        ...
        <h4 className="title"> <img class="puzzle-piece" src={puzzle} alt="Quebra-Cabeça representativo do TEA"/> Cadastro TEA (Transtorno do Espectro Autista)</h4>
          <hr />
        </div>
      </div>
