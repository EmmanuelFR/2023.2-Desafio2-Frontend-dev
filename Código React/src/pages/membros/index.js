...
import mother from '../../images/person-breastfeeding-solid.svg';
  ...
  return (
    <div className="container">
      ...
      <div className="row mt-3">
        ...
        <h4 className="title"> <img class="mother" src={mother} alt="Quebra-Cabeça representativo do TEA"/> Cadastro de Membros (Responsáveis e Profissionais ligados ao grupo)</h4>
          <hr />
        </div>
      </div>
